...
public class ModuleService extends BaseService<Module,Integer> {
    ...
    public void saveModule(Module module){
        ...
        AssertUtil.isTrue(org.apache.commons.lang3.StringUtils.isBlank(module.getModuleName()),"请输入菜单名!");
        ...
        if(grade==1){
            AssertUtil.isTrue(org.apache.commons.lang3.StringUtils.isBlank(module.getUrl()),"请输入二级菜单url地址!");
        ...
        AssertUtil.isTrue(org.apache.commons.lang3.StringUtils.isBlank(module.getOptValue()),"请输入菜单权限码!");
    ...
    public void deleteModule(Integer mid){
        ...
        if (total>0){
         AssertUtil.isTrue(   permissionMapper.deletePermissionByModuleId(mid)!=total,"菜单删除是阿拜"); }
